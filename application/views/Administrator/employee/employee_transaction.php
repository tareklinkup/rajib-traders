		...
		<div class="row" style="margin-top: 10px;margin-bottom:15px;border-bottom: 1px solid #ccc;padding-bottom: 15px;">
			<div class="col-md-5 col-md-offset-1">
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<select class="form-control" v-model="transaction.transaction_type" required style="padding: 0px 1px;">
				...
				<div class="form-group clearfix">
					...
					<div class="col-sm-7">
						<select v-model="transaction.transaction_for" class="form-control" v-on:input="onTransactionForChange" style="padding: 0px 1px;">
			...
			<div class="col-md-5">
				...
				<div class="form-group" style="display:none" :style="{display:transaction.transaction_type == 'Payment' ? '' : 'none'}">
				...
				<div class="form-group" style="display:none" :style="{display:transaction.transaction_type == 'Receive' ? '' : 'none'}">
