        ...
        <div class="col-md-12">
            <form class="form-inline" id="searchForm" @submit.prevent="getTransactions">
                ...
                <div class="form-group" style="display:none;" v-bind:style="{display: accounts.length > 0 ? '' : 'none'}">
                    ...
                    <v-select v-bind:options="accounts" v-model="selectedAccount" label="Acc_Name" @input="onChangeAccount();getSubAccounts()"></v-select>
                </div>
        ...
        methods: {
            ...
            getTransactions() {
                if (this.selectedSubAccount == null || this.selectedSubAccount.sub_acc_id == undefined) {
                    this.filter.sub_acc_id = '';
                } else {
                    this.filter.sub_acc_id = this.selectedSubAccount.sub_acc_id;
                }
