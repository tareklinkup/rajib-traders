...
<ul class="nav nav-list">
    ...
    <?php if (
			...
			|| array_search("add_sub_account", $access) > -1
    ...
    <li>
        ...
        <ul class="submenu">
            ...
            <?php if (array_search("add_sub_account", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
            <li>
                <a href="<?php echo base_url(); ?>add_sub_account">
                    <i class="menu-icon fa fa-caret-right"></i>
                    Trans. Sub Accounts
                </a>
                <b class="arrow"></b>
...
<ul class="nav nav-list">
    ...
    <?php if (array_search("employee_transaction", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
    <li class="">
        <a href="<?php echo base_url(); ?>employee_transaction">
            <i class="menu-icon fa fa-money"></i>
            <span class="menu-text"> Emp. Transaction </span>
        </a>
        <b class="arrow"></b>
    </li>
    <?php endif; ?>
    ...
    <?php if (
			...
			|| array_search("employee_transaction_report", $access) > -1
    ...
    <li class="">
        ...
        <ul class="submenu">
            ...
            <?php if (array_search("employee_transaction_report", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
            <li class="">
                <a href="<?php echo base_url(); ?>employee_transaction_report">
                    <i class="menu-icon fa fa-caret-right"></i>
                    Employee Trans. Report
                </a>
                <b class="arrow"></b>
            </li>
            <?php endif; ?>

            <?php if (array_search("employee_salary_report", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
            <li class="">
                <a href="<?php echo base_url(); ?>employee_salary_report">
                    <i class="menu-icon fa fa-caret-right"></i>
